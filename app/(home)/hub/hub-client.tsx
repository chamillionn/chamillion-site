...
export default function HubPage({ userRole }: HubProps) {
    ...
    <div className={`page-transition ${styles.page}`}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.closing}>
          {isFree ? (
            <>
              <p className={styles.closingQuote}>Contenido exclusivo</p>
              <p className={styles.closingHint}>
                El Hub es exclusivo para suscriptores. Suscribete para acceder
                cuando se lance.
              </p>
              <div className={styles.closingLinks}>
                <button disabled className={styles.primaryLink} style={{ opacity: 0.5, cursor: "not-allowed" }}>
                  Proximamente
                </button>
